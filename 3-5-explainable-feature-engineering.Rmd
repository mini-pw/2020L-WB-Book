...
Feauture importance is a metric showing which predictors (columns) are the most important to the model's final prediction. The metric becomes more and more significant, because machine learning algorithms play an important role in almost any decision making process from banking to medical areas. A more precise description of Feature Importance may be found in [ref]. 
