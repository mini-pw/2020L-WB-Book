...
As cited from “What does research reproducibility mean?” [@Goodman341ps12] by Steven N. Goodman, Daniele Fanelli and John P. A. Ioannidis;
...
Other notable articles about reproducibility include “Variability and Reproducibility in Software Engineering: A Study of Four Companies that Developed the Same System” [@Anda407] by Bente C.D. Anda, Dag I.K. Sjøberg and Audris Mockus, “Reproducible Research in Computational Science” [@Peng1226] by Roger D. Peng and “A statistical definition for reproducibility and replicability” [@Patil066803] by Prasad Patil, Roger D. Peng and Jeffrey T. Leek.
