...
*Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ultricies blandit tellus imperdiet iaculis. Vestibulum et orci elementum, fermentum dui at, varius quam. Fusce mattis nisi id fringilla ultrices. Pellentesque ornare, lacus sed tempus dapibus, risus tellus tempor tellus, id egestas dolor sapien eget lectus. Morbi bibendum vehicula nunc, sed convallis quam porta a. Phasellus scelerisque dui ex, ut pharetra sapien tempor sed. Phasellus vitae ultricies ante, sed dictum orci. Nullam maximus nunc in augue efficitur, id hendrerit mi efficitur.Maecenas a lobortis est. Morbi a imperdiet neque, ut elementum diam. Praesent viverra mi id nibh cursus, sed pulvinar mi posuere. Vivamus cursus enim quis augue ultrices, sed elementum erat volutpat. Sed vitae turpis nec augue mattis facilisis quis sed nunc. Nam tincidunt risus et accumsan laoreet. Praesent iaculis neque dui, a auctor diam laoreet ut. Integer mattis ipsum sed nisi iaculis laoreet. Nullam ante purus, commodo a vehicula quis.*
...
Dataset was split on the train and test dataset, and that split will be the same for all experiments covered in this section. To begin with we need to introduce the AutoML model that was used as a goal to beat. H2O AutoML[@H2OAutoML] was used to find the best black-box solution over the provided training dataset. As interpretation R-squared coefficient of determination is not the same for linear models and black-box, we will present a comparison of the found solution to the AutoML model using only $L_{0}$ measure. Table 1 shows parameters of the back-box model which appears to be Gradient Boosting Machine.
