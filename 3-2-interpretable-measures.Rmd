...
We train the models into data that we have divided into five folds with a similar distribution of the decision variable, on which we will perform cross-validation [ref]. Then we compare the results using commonly used measures of model effectiveness [ref]:
