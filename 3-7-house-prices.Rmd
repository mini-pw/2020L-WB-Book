...
The use of ML in the real estate domain is a well-documented ground [@3-7-realestate-ai] and not precisely a topic of this contribution. We relate to the works that aim to use Interpretable ML techniques [@molnar2019] to interpret models predictions in the house price estimation problem. 
